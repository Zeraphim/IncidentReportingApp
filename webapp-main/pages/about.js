        ...
        <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/agap-3fe00.appspot.com/o/About%20Us%2Fmember_antonio.png?alt=media&token=9c06a8bb-ecfc-41c8-bbe8-2bf3f505a58f"></img>
                    <h2 class="text-lg font-medium">ANTONIO, Karmin Ida Mae</h2>
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/agap-3fe00.appspot.com/o/About%20Us%2Fmember_jc.png?alt=media&token=322b1a69-4b4b-441e-b468-ac9bda57b1ce"></img>
                    <h2 class="text-lg font-medium">DIAMANTE, John Christian</h2>
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/agap-3fe00.appspot.com/o/About%20Us%2Fmember_espejo.png?alt=media&token=aaa07b57-fcbe-4177-97d6-05c1b609a1f0"></img>
                    <h2 class="text-lg font-medium">ESPEJO, Tia Julienne</h2>
                    <p class="font-medium text-blue-500">Backend Developer (DBMS)</p>
                    </div>
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/agap-3fe00.appspot.com/o/About%20Us%2Fmember_miguel.png?alt=media&token=0065caa6-c307-4dea-a63c-f91528b97c1f"></img>
                    <h2 class="text-lg font-medium">MIGUEL, Maria Isabella Angela</h2>
                    <p class="font-medium text-blue-500">Frontend Developer</p>
                  </div>
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="https://firebasestorage.googleapis.com/v0/b/agap-3fe00.appspot.com/o/About%20Us%2Fmember_zaguirre.png?alt=media&token=a7de71f7-0540-4e8a-ab4c-074e33c42556"></img>
                    <h2 class="text-lg font-medium">ZAGUIRRE, Stephanie Anne</h2>
