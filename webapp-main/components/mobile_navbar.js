...
const MobileNavBar = (props) => {
  return (
    <div className="grid grid-cols-3 fixed bottom-0 lg:hidden w-screen rounded-t-lg shadow-lg">
      <div className="col-span-1 p-3 flex justify-center items-center relative">
        <svg
          width="30"
          height="30"
          viewBox="0 0 20 20"
